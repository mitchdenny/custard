...
| [`protocol.js`](../samples/WebTerminalDemo/wwwroot/protocol.js) | Transport- and GPU-independent frame decoder. |
| [`terminal-worker.js`](../samples/WebTerminalDemo/wwwroot/terminal-worker.js), [`renderer.js`](../samples/WebTerminalDemo/wwwroot/renderer.js) | Reference receiver state machine, resource transactions, presentation, and acknowledgement policy. |
| [`web-terminal.js`](../samples/WebTerminalDemo/wwwroot/web-terminal.js), [`mouse-input.js`](../samples/WebTerminalDemo/wwwroot/mouse-input.js) | Element-local mounting, fitting, role callbacks, and browser event capture/filtering. |
| [`main.js`](../samples/WebTerminalDemo/wwwroot/main.js) | Floating-window playground; not a dependency of the mounted client. |
...
HMP1's [graphics replay and animation checkpoint](../docs/muxer-protocol.md#kgpanimationstate-0x0c)
...
There is no frame-level application/synchronized-output transaction guarantee
beyond a consistent captured snapshot.
