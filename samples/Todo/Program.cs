            ...
            new ResponsiveWidget([
                ...
                new ConditionalWidget((w, h) => true,
                    new VStackWidget([
                        ...
                        new TextBlockWidget(GetProgressBar()),
                        new TextBlockWidget(""),
                        new ListWidget(listItems).OnSelectionChanged(args => OnSelectionChanged(args)).OnItemActivated(_ => ToggleSelected()).FillHeight(),
                        new TextBlockWidget(""),
                        new HStackWidget([
                            new TextBoxWidget(newItemText).OnTextChanged(args => newItemText = args.NewText).FillWidth(),
