...
/// When a <see cref="Terminal.RenderOptimizationFilter"/> (or similar filter) receives this token,
...
/// </para>
/// <para>
/// Uses APC (Application Program Command) format: ESC _ HEX1B:FRAME:BEGIN ESC \
/// </para>
/// </remarks>
