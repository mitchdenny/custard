...
public sealed record TextBoxWidget(string? Text = null) : Hex1bWidget
{
    ...
    /// <summary>
    /// Attaches a synchronous text changed handler.
    /// </summary>
    ...
    /// <summary>
    /// Attaches an asynchronous text changed handler.
    /// </summary>
    public TextBoxWidget OnTextChanged(Func<TextChangedEventArgs, Task> handler)
        => this with { TextChangedHandler = handler };

    /// <summary>
    /// Attaches a synchronous submit handler (called when Enter is pressed).
    /// </summary>
    ...
    /// <summary>
    /// Attaches an asynchronous submit handler (called when Enter is pressed).
    /// </summary>
