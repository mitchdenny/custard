...
/// <summary>
/// Tests for the CustardTerminal virtual terminal emulator.
/// </summary>
public class CustardTerminalTests
{
    [Fact]
    ...
    {
        using var terminal = new CustardTerminal(10, 5);
    ...
    {
        using var terminal = new CustardTerminal(20, 5);
    ...
    {
        using var terminal = new CustardTerminal(5, 3);
    ...
    public async Task SendKeyAsync_InjectsInputEvent()
    {
        ...
        var events = new List<CustardInputEvent>();
    ...
    {
        using var terminal = new CustardTerminal(40, 5);
