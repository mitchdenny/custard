...
public class VStackNodeTests
{
    ...
    public void Arrange_PositionsChildrenVertically()
    {
        ...
        var node = new VStackNode { Children = new List<CustardNode> { child1, child2 } };
    ...
    public void Arrange_WithFillHints_DistributesSpace()
    {
        ...
        var node = new VStackNode
        {
            Children = new List<CustardNode> { child1, child2 },
    ...
    public void GetFocusableNodes_FindsAllFocusable()
    {
        ...
        var node = new VStackNode
        {
            Children = new List<CustardNode> { textBox1, button, textBlock, textBox2 }
        };
    ...
    public void HandleInput_Tab_MovesFocus()
    {
        ...
        var node = new VStackNode
        {
            Children = new List<CustardNode> { textBox1, textBox2 }
        };
    ...
    public void HandleInput_DispatchesToFocusedChild()
    {
        ...
        var node = new VStackNode { Children = new List<CustardNode> { textBox } };
        node.InvalidateFocusCache();
    ...
    {
        using var terminal = new CustardTerminal(40, 10);
        var context = new CustardRenderContext(terminal);
